      ...
      <div class="panel-bd">
        <div class="total-number" style="margin-left: 3px">
          <div class="total-text">
              已提交企业
            <span class="num" style="color: green">{{ count.one }}</span
            >家
          </div>
          <div class="total-text is-offline">
            未提交企业
            <span class="num" style="color: red">{{ count.two }}</span
            >家
          </div>
        </div>
          ...
          <tbody>
            <tr v-for="(item, index) in dataList">
              ...
              >
                ...
                <div v-if="item.auditStatus == 0" class="text-state untreated">
                  已提交未审核
                </div>
                <div v-if="item.auditStatus == 1" class="text-state">
                  审核通过
                </div>
                <div
          ...
          <table class="mytable-default">
            ...
            <tbody>
              ...
              >
                ...
                >
                  {{
                    (item.productionNumber ? item.productionNumber : 0).toFixed(
                      2
                    )
                  }}
                </td>
